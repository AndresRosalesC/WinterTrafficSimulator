...
public class Intersection implements Animatable{
    ...
    public Intersection(String id) {
        ...
        this.posX = SimulationGraphicConfig.VERTICAL_ROAD_X_POS_SOUTH;
        this.posY = SimulationGraphicConfig.HORIZONTAL_ROAD_Y_POS_WEST;
    }
    ...
    public void draw(Graphics graphics) {
        ...
        try{
            ...
            canvas.drawImage(intersection_image, posX, posY, SimulationGraphicConfig.ROAD_WIDTH*2, SimulationGraphicConfig.ROAD_WIDTH*2, null);
        }
        catch (Exception e){
            e.printStackTrace();
        }
