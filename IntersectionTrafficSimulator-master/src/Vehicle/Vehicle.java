...
public class Vehicle implements Animatable, Simulatable {
    ...
    private boolean pasttl;
    private boolean runred = false;
    private boolean nearmiss = false;
    private int init_speed = 30;

    public Vehicle(String id, Road road) {
        this.id = id;
        this.speed = init_speed;
        this.dspeed = init_speed;
        this.road = road;
        this.waitingTime = 0;
    ...
    public void setSpeed(double speed){
    	if (orderID==1) {
    	System.out.println("transformacion " + speed);
    	}
    	...
    	this.dspeed = speed;
    	if (orderID==1) {
    	System.out.println("lo anterior al vehiculo " + this.speed);
    	System.out.println("lo que entra al vehiculo " + (int)Math.round(speed));
    	}
    ...
    public void switchptl(){
    	this.pasttl = true;
    }
    public void swRunred(){
    	this.runred = true;
    }
    public void swNearmiss(){
    	this.nearmiss = true;
    }
    public boolean getRunred() {
    	return runred;
    }
